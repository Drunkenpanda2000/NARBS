...
# DEFAULTS:
[ -z ${dotfilesrepo+x} ] && dotfilesrepo="https://github.com/drunkenpanda2000/abysrice.git"
[ -z ${progsfile+x} ] && progsfile="https://raw.githubusercontent.com/drunkenpanda2000/NARBS/master/progs.csv"
